...
def init_3d():
    ...
    motion_visualizers.append(MotionVisualizer.MotionVisualizer(left, True, udpHandler, deltaTime))
    motion_visualizers.append(MotionVisualizer.MotionVisualizer(right, False, udpHandler, deltaTime))
